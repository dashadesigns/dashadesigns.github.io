...
const paper41 = document.querySelector("#p41");
const paper42 = document.querySelector("#p42");
const paper43 = document.querySelector("#p43");
    ...
    if (currentLocation < maxLocation) {
        switch (currentLocation) {
            ...
            case 40:
                ...
                break;
            case 41:
                paper41.classList.add("flipped");
                paper41.style.zIndex = 41;
                break;
            case 42:
                paper42.classList.add("flipped");
                paper42.style.zIndex = 42;
                break;

            case 43:
                paper43.classList.add("flipped");
                paper43.style.zIndex = 43;
                closeBook(false);
                break;
            default:
    ...
    if (currentLocation > 1) {
        switch (currentLocation) {
            case 2:
                ...
                paper1.style.zIndex = 43;
                break;
            case 3:
                paper2.classList.remove("flipped");
                paper2.style.zIndex = 42;
                break;
            case 4:
                paper3.classList.remove("flipped");
                paper3.style.zIndex = 41;
                break;
            case 5:
            ...
            case 6:
                ...
                paper5.style.zIndex = 39;
                break;
            case 7:
                paper6.classList.remove("flipped");
                paper6.style.zIndex = 38;
                break;
            case 8:
                paper7.classList.remove("flipped");
                paper7.style.zIndex = 37;
                break;
            case 9:
                paper8.classList.remove("flipped");
                paper8.style.zIndex = 36;
                break;
            case 10:
                paper9.classList.remove("flipped");
                paper9.style.zIndex = 35;
                break;
            case 11:
                paper10.classList.remove("flipped");
                paper10.style.zIndex = 34;
                break;
            case 12:
                paper11.classList.remove("flipped");
                paper11.style.zIndex = 33;
                break;
            case 13:
                paper12.classList.remove("flipped");
                paper12.style.zIndex = 32;
                break;
            case 14:
                paper13.classList.remove("flipped");
                paper13.style.zIndex = 31;
                break;
            case 15:
                paper14.classList.remove("flipped");
                paper14.style.zIndex = 30;
                break;
            case 16:
                paper15.classList.remove("flipped");
                paper15.style.zIndex = 29;
                break;
            case 17:
                paper16.classList.remove("flipped");
                paper16.style.zIndex = 28;
                break;
            case 18:
                paper17.classList.remove("flipped");
                paper17.style.zIndex = 27;
                break;
            case 19:
                paper18.classList.remove("flipped");
                paper18.style.zIndex = 26;
                break;
            case 20:
                paper19.classList.remove("flipped");
                paper19.style.zIndex = 25;
                break;
            case 21:
                paper20.classList.remove("flipped");
                paper20.style.zIndex = 24;
                break;
            case 22:
                paper21.classList.remove("flipped");
                paper21.style.zIndex = 23;
                break;
            case 23:
            ...
            case 24:
                ...
                paper23.style.zIndex = 21;
                break;
            case 25:
                paper24.classList.remove("flipped");
                paper24.style.zIndex = 20;
                break;
            case 26:
                paper25.classList.remove("flipped");
                paper25.style.zIndex = 19;
                break;
            case 27:
                paper26.classList.remove("flipped");
                paper26.style.zIndex = 18;
                break;
            case 28:
                paper27.classList.remove("flipped");
                paper27.style.zIndex = 17;
                break;
            case 29:
                paper28.classList.remove("flipped");
                paper28.style.zIndex = 16;
                break;
            case 30:
                paper29.classList.remove("flipped");
                paper29.style.zIndex = 15;
                break;
            case 31:
                paper30.classList.remove("flipped");
                paper30.style.zIndex = 14;
                break;
            case 32:
                paper31.classList.remove("flipped");
                paper31.style.zIndex = 13;
                break;
            case 33:
                paper32.classList.remove("flipped");
                paper32.style.zIndex = 12;
                break;
            case 34:
                paper33.classList.remove("flipped");
                paper33.style.zIndex = 11;
                break;
            case 35:
                paper34.classList.remove("flipped");
                paper34.style.zIndex = 10;
                break;
            case 36:
                paper35.classList.remove("flipped");
                paper35.style.zIndex = 9;
                break;
            case 37:
                paper36.classList.remove("flipped");
                paper36.style.zIndex = 8;
                break;
            case 38:
                paper37.classList.remove("flipped");
                paper38.style.zIndex = 7;
                break;
            case 39:
                paper38.classList.remove("flipped");
                paper38.style.zIndex = 6;
                break;
            case 40:
                paper39.classList.remove("flipped");
                paper39.style.zIndex = 5;
                break;
            case 41:
                paper40.classList.remove("flipped");
                paper40.style.zIndex = 4;
                break;
            case 42:
                paper41.classList.remove("flipped");
                paper41.style.zIndex = 3;
                break;
            case 43:
                paper42.classList.remove("flipped");
                paper42.style.zIndex = 2;
                break;
            case 44:
                openBook();
                paper43.classList.remove("flipped");
                paper43.style.zIndex = 1;
                break;
            default:
                throw new Error("unkown state");
        }
